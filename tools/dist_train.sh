...
# bash tools/dist_train.sh 'configs/rotated_fcos/rotated_fcos_r50_fpn_1x_brickkiln_le90.py' 3

# bash tools/dist_train.sh 'configs/rotated_fcos/rotated_fcos_kld_r50_fpn_1x_brickkiln_le90.py' 3
