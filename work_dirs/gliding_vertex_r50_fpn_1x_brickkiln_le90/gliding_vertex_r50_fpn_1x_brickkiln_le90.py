...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            fix_coder=dict(type='GVFixCoder', angle_range='le90'),
            ratio_coder=dict(type='GVRatioCoder', angle_range='le90'),
            reg_class_agnostic=True,
            loss_cls=dict(
                type='CrossEntropyLoss', use_sigmoid=False, loss_weight=1.0),
            loss_bbox=dict(type='SmoothL1Loss', beta=1.0, loss_weight=1.0),
            loss_fix=dict(
                type='SmoothL1Loss', beta=0.3333333333333333, loss_weight=1.0),
            loss_ratio=dict(
                type='SmoothL1Loss', beta=0.3333333333333333,
                loss_weight=16.0))),
    train_cfg=dict(
        rpn=dict(
            assigner=dict(
...
batch_size = 128
num_epochs = 25
work_dir = './work_dirs/gliding_vertex_r50_fpn_1x_brickkiln_le90'
auto_resume = False
gpu_ids = range(0, 1)
